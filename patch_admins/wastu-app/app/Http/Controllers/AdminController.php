...
class AdminController extends Controller
{
    ...
    public function storeAdmin(Request $request)
    {
        ...
        return redirect()->route('admin.admins.index')->with('success', 'Akun Staf Admin berhasil dibuat.');
    }
    ...
    public function updateAdmin(Request $request, $id)
    {
        ...
        return redirect()->route('admin.admins.index')->with('success', 'Akun Staf Admin berhasil diperbarui.');
    }
    ...
    public function deleteAdmin($id)
    {
        ...
        if ($admin->id == 1) {
            return redirect()->route('admin.admins.index')->withErrors('Akun Super Admin (Utama) tidak boleh dihapus!');
        }

        // Prevent self deletion
        if (auth()->id() == $admin->id) {
            return redirect()->route('admin.admins.index')->withErrors('Anda tidak bisa menghapus akun Anda sendiri saat sedang login!');
        }

        $admin->delete();
        return redirect()->route('admin.admins.index')->with('success', 'Akun Staf Admin berhasil dihapus.');
    }
    ...
    public function backupDatabase()
    {
        ...
        if ($driver === 'sqlite') {
            ...
            if (!file_exists($databasePath)) {
                return back()->withErrors('File database tidak ditemukan.');
            }
            $filename = "pt_wastu_backup_" . date('Ymd_His') . ".sqlite";
