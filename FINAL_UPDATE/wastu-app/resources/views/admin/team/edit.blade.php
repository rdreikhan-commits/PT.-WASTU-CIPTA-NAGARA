            ...
            <div class="mb-3">
                ...
                @if($member->photo_path)
                    <div class="mt-3">
                        ...
                        <div style="width: 100px; height: 100px; overflow: hidden; background-color: #ECECEC; border-radius: 8px;">
                            <img src="{{ Storage::url($member->photo_path) }}" class="w-100 h-100" style="object-fit: cover;" alt="Current Photo">
                        </div>
                    </div>
                @endif
            </div>
