            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    @if($article->thumbnail)
                        <div class="mt-3">
                            <p class="small text-muted mb-2">Thumbnail saat ini:</p>
                            <div style="width: 150px; height: 100px; overflow: hidden; background-color: #ECECEC; border-radius: 8px;">
                                <img src="{{ Storage::url($article->thumbnail) }}" class="w-100 h-100" style="object-fit: cover;" alt="Current Thumbnail">
                            </div>
                        </div>
                    @endif
                </div>
